...
We include two methods, one *supervised* that uses a bilingual dictionary, and one *unsupervised* that does not use any parallel data (see [Word Translation without Parallel Data](https://arxiv.org/pdf/1710.04087.pdf) for more details).
...
* Our 90 [bilingual dictionaries](https://github.com/facebookresearch/MUSE#ground-truth-bilingual-dictionaries)
...
./get_evaluation.sh
```
*Note: Requires bash 4. The download of Europarl is disabled by default (slow), you can enable it [here](https://github.com/facebookresearch/MUSE/blob/master/data/get_evaluation.sh#L81-L105).*
...
As part of our evaluation pipeline, we release our ground-truth bilingual dictionaries, which were created using an internal translation tool. They handle well the polysemy of words and can be used either for training or evaluation. We provide a train and test split of 5000 and 1500 unique source words, as well as a larger set of up to 100k pairs.

Our goal is to ease the development and the evaluation of cross-lingual word embeddings and multilingual NLP.
...
Please cite [[1]](https://arxiv.org/pdf/1710.04087.pdf) if using this code for learning or evaluating cross-lingual word representations.
...
*Illustration of [Word translation without parallel data](https://arxiv.org/pdf/1710.04087.pdf) - see paper for more details*
