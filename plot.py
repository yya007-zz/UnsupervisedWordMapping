...
fig = plt.figure()
plt.plot(e1['epoch_train'][:10],e1[features[0]+"_t_train"][:10],'-',label='lambda=0 beta=0.001')
plt.plot(e3['epoch_train'],e3[features[0]+"_t_train"],'-',label='lambda=0 beta=0')
...
fig = plt.figure()
plt.plot(e1['epoch_train'][:10],e1[features[0]+"_f_train"][:10],'-',label='lambda=0 beta=0.001')
plt.plot(e3['epoch_train'],e3[features[0]+"_f_train"],'-',label='lambda=0 beta=0')
