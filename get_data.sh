...
if [ -f "$FILE" ]; then
	...
	wget -q https://s3-us-west-1.amazonaws.com/fasttext-vectors/wiki.en.vec -O "$FILE"
fi

FILE="$DATA/pretrained/it.vec"
if [ -f "$FILE" ]; then
	echo "$FILE exists."
else
	wget -q https://s3-us-west-1.amazonaws.com/fasttext-vectors/wiki.it.vec -O "$FILE"
fi

FILE="$DATA/pretrained/ge.vec"
if [ -f "$FILE" ]; then
	echo "$FILE exists."
else
	wget -q https://s3-us-west-1.amazonaws.com/fasttext-vectors/wiki.ge.vec -O "$FILE"
fi

FILE="$DATA/pretrained/fr.vec"
if [ -f "$FILE" ]; then
	echo "$FILE exists."
else
	wget -q https://s3-us-west-1.amazonaws.com/fasttext-vectors/wiki.fr.vec -O "$FILE"
fi
...
wget -q http://ixa2.si.ehu.es/eneko/tmp/vecmap/fi.emb.txt.gz -O "$DATA/embeddings/original/fr.emb.txt.gz"
...
# python "$ROOT/normalize_embeddings.py" unit -i "$DATA/embeddings/original/en.emb.txt" -o "$DATA/embeddings/unit/en.emb.txt"
# python "$ROOT/normalize_embeddings.py" unit -i "$DATA/embeddings/original/it.emb.txt" -o "$DATA/embeddings/unit/it.emb.txt"
# python "$ROOT/normalize_embeddings.py" unit -i "$DATA/embeddings/original/de.emb.txt" -o "$DATA/embeddings/unit/de.emb.txt"
# python "$ROOT/normalize_embeddings.py" unit -i "$DATA/embeddings/original/fi.emb.txt" -o "$DATA/embeddings/unit/fi.emb.txt"
# python "$ROOT/normalize_embeddings.py" unit center -i "$DATA/embeddings/original/en.emb.txt" -o "$DATA/embeddings/unit-center/en.emb.txt"
# python "$ROOT/normalize_embeddings.py" unit center -i "$DATA/embeddings/original/it.emb.txt" -o "$DATA/embeddings/unit-center/it.emb.txt"
# python "$ROOT/normalize_embeddings.py" unit center -i "$DATA/embeddings/original/de.emb.txt" -o "$DATA/embeddings/unit-center/de.emb.txt"
# python "$ROOT/normalize_embeddings.py" unit center -i "$DATA/embeddings/original/fi.emb.txt" -o "$DATA/embeddings/unit-center/fi.emb.txt"
